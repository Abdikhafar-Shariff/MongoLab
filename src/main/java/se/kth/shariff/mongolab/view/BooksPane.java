...
import se.kth.shariff.mongolab.model.Author;
import se.kth.shariff.mongolab.model.Book;
import se.kth.shariff.mongolab.model.BooksImplements;
import se.kth.shariff.mongolab.model.SearchMode;
    ...
    private void showAddBookDialog() {
        ...
        dialog.setResultConverter(dialogButton -> {
            if (dialogButton == ButtonType.OK) {
                ...
                Date published = Date.from(publishedDate.atStartOfDay(ZoneId.systemDefault()).toInstant());
    ...
    private void showAddAuthorDialog() {
        ...
        dialog.setResultConverter(dialogButton -> {
            if (dialogButton == ButtonType.OK) {
                ...
                return new Author(nameField.getText(), birthDate); // Return the new Author object
            }
            return null;
        });
